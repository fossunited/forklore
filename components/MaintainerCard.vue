...
<template>
  <div
    ...
    @click="$router.push(maintainer.meta.path)"
  >
    <div
    ...
    >
      <img
        ...
        v-if="maintainer.meta.photo"
        :src="maintainer.meta.photo"
      />
      <img
        class="w-8 h-8 aspect-square"
        v-else
    ...
    <div
      ...
      :class="
        maintainer.meta.projects.length > 1
          ? 'md:grid-cols-2 divide-x-custom'
          : 'md:grid-cols-1'
      "
    >
      <ProjectCard
        v-for="project in maintainer.meta.projects"
        :key="project.name"
        :project="project"
      />
    </div>
